	...
	<header id="header">
        ...
        <div class="logo">
			...
			<ul>
                ...
                <li><a href="meet1.php">Users Meet</a></li>
...
$req = $bdd->query("SELECT * FROM meet");

// Créer un tableau HTML pour afficher les utilisateurs 
echo "<table>"; echo "<tr>"; echo "<th>Id</th>"; echo "<th>Nom</th>"; echo "<th>prenom</th>"; echo "<th>Email</th>"; echo "<th>Sujet</th>"; echo "<th>Action</th>"; echo "</tr>";

// Parcourir les utilisateurs 
while ($meet= $req->fetch()) { // Récupérer les données de l’utilisateur 
    $id = $meet["id"]; $nom = $meet["nom"]; $prenom = $meet["prenom"]; $email = $meet["email"]; $sujet = $meet["sujet"];
...
echo "<a href='edit_meet.php?id=$id'><i class='fa fa-edit'></i></a>"; 
// Bouton pour supprimer l’utilisateur 
echo "<a href='delete_meet.php?id=$id'><i class='fa fa-trash'></i></a>";
echo "</td>";
echo "</tr>";
