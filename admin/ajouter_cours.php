...
$sql = "SELECT id, titre, description, module, image FROM cours";
...
if ($result && $result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    ...
    <td><a href='edit.php?id=".$row["id"]."' style='color: green;'><i class='fa fa-pencil'></i> Éditer</a> <a href='accepter.php?id=".$row["id"]."' style='color: blue;'><i class='fa fa-check'></i> Accepter</a> <a href='refuse.php?id=".$row["id"]."' style='color: red;'><i class='fa fa-trash'></i> Refuser</a></td></tr>";
  }
} else {
  echo "0 results";
}
...
echo "</table>";
echo "<a href='add.php'>Ajouter <i class='fa fa-plus'></i></a>";
